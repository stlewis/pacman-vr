...
AFRAME.registerComponent('pinky-behavior', {
  ...
  tick: function() {
    ...
    // If pacman is facing north, choose a candidate with an X or a Z greater than pacman's current X/Z
    ...
    // If pacman is facing south, choose a candidate with an X or a Z less than pacman's current X/Z
    ...
    // If pacman is facing east, choose a candidate with an X less than pac's position, or a Z greater than pac's position
